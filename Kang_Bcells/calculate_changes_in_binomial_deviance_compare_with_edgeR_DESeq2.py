...
def ROC_plots ( DE_threshold ):
  ...
  title4 = '\n define genes as Differentially Expressed if  abs ( log2 ( DEFacGroup2 / DEFacGroup1 ) ) > '  + '{0:.2f}'.format( DE_threshold )  
...
for simulation in  range(1, 1 + number_of_simulations ):
  ...
  df_row_data['true_DE'] = np.log2 ( df_row_data['DEFacGroup2'] ) - np.log2 ( df_row_data['DEFacGroup1'] )
  df_row_data['abs_true_DE'] = np.abs ( df_row_data['true_DE' ] )       
  print ( '\n\n\n df_row_data: \n\n', df_row_data )  
